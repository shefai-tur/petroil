  ...
  return (
    <section className="pt-[88px] pb-11 bg-black">
      <div className="max-w-container mx-auto px-2.5 md:px-0">
          ...
          <div className="w-2/5">
            ...
            <ul className="text-white mt-8 font-pop font-regular text-sm ml-4">
              <li className=" relative">
                <IoMdMailUnread className="absolute mt-[6px] ml-[-20px]" />
                mail@yourcompany.com
              </li>
              <li className="relative py-3.5">
                <BiPhoneCall className="absolute mt-[6px] ml-[-20px]" />
                +896 120 5889 (Toll free)
              </li>
              <li className="relative">
                <RiRoadMapLine className="absolute mt-[6px] ml-[-20px]" />
        ...
        <h4 className="text-para mt-[213px]">
